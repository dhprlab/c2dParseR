...
of data is contained and how it is organized. The intended audience are
users who want to extract their research- or training-relevant data from
`.c2d` files for analysis in R. Any contained data for internal use by
the Cyclus2 software is not of interest and thus omitted here.
...
- `Training` contains the data of the training session, including the
  date, the header, and the row data for each time point.
