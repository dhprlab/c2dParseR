...
Below is a list of possible `Header` values and their corresponding meaning (though that's work in progress!).
...
48. `idStageIndex`: new since Aug 2021, such that jumps in stages remain visible/traceable
